...
export const getFullSprintShootout = async (year: number = new Date().getFullYear(), raceName: string = "Brazil"): Promise<isFullRaceResult[]> => {
    try {
        ...
        return getF1Table(sprintQualiURL, assignQualiValues) as unknown as isFullRaceResult[];
    } catch (error: unknown) {
